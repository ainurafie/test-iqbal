...
@section('content')
    <div class="row">
        <div class="col-10">
            <h5>Buat Rekening</h5>
            <form action="{{ route('rekening.store') }}" method="post" class="mt-5" id="custom_form" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-6">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="sub_rekening" id="sub_rekening" value="{{ old('sub_rekening') }}" class="form-control">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_rekening" id="nama_rekening" value="{{ old('nama_rekening') }}" class="form-control">
                        </div>
                    </div>
                </div>
